...
export const enUS: Record<TranslationKey, string> = {
  ...
  'builder.groups.cabinetBoxes.label': 'Cabinets',
  'builder.groups.cabinetBoxes.why':
    'Carcass material — the cabinet layout is locked from your confirmed plan.',
  ...
  'cabinetBoxes.recap.title': 'Locked layout',
  ...
  'kitchen.home.act.build': 'Build the kitchen — doors, worktop, hardware, appliances.',
  'kitchen.home.act.details': 'Details — scope of work, timing, site access.',
